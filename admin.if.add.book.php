...
if (!empty($_POST["how_much"]))
{
    if (isset($_SESSION["ifadded"]) && isset($_POST['book_name1']) && isset($_POST['author1']) && isset($_POST['publishing_house1']) && isset($_POST['year_of_publication1']))
    if ($_SESSION["ifadded"] == $_POST['book_name1'].$_POST['author1'].$_POST['publishing_house1'].$_POST['year_of_publication1'])
    {
    ...
    if ($_SESSION["ifadded"] != $_POST['book_name1'].$_POST['author1'].$_POST['publishing_house1'].$_POST['year_of_publication1'])
    {
        ...
        $how_much = filter_var($_POST["how_much"] , FILTER_SANITIZE_NUMBER_INT);
        $_SESSION["ifadded"] = $_POST['book_name1'].$_POST['author1'].$_POST['publishing_house1'].$_POST['year_of_publication1'];
