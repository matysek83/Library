...
if (isset($_POST['login']) && isset($_POST['password']) || $_SESSION['zalogowany'] == 1)
{
    if ((!empty($_POST['login']) && !empty($_POST['password'])) || $_SESSION['zalogowany'] == 1)
    {
       ...
       if (($login == "matys" && $password == "abc")||($login == "user" && $password == "1234") || $_SESSION['zalogowany'] == 1)
                ...
                echo "<br/><a href='cnc.php?akcja=wyloguj'><i>Wyloguj</i></a>";
...
//----database settings
define ("mysql_host", "cba.pl");
define ("mysql_username", "admin@pasje.biz");
define ("mysql_password", "area51");
define ("mysql_database", "matys83");
define ("mysql_table", "shoutbox");

//----admin settings
define("admin_username", "Matys");
define("admin_password", "abc");

//----misc settings
define("script_filename", "shoutbox.php");
