...
<meta name="author" content="Mateusz Sikora" />
<meta name="robots" content="index, follow" />
<meta name="description" content="Tworzenie stron i programowanie" />
<meta name="keywords" content="PHP, CSS, JavaScript, AJAX, C++, TurboPascal, MySQL, programowanie" />		
</head>
<body>
<?php
/*
...
$username = "matys83_pasje"; //change username to the one you use to connect to your own mysql database here
$password = "area5432"; //password for database here
$database = "matys83_pasje"; //database name where you want to create your webstats
